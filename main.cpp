...
vec3 vec_directeurlat = vec3(-0.5f,0.0f,0.0f);
vec3 vec_directeurhaut = vec3(0.0f,-2.0f,0.0f);
bool UP = false;
bool DOWN = false;
bool LEFT = false;
bool RIGHT = false;
 ...
 static void display_callback()
{
  ...
  if (UP == true){
    cam.tr.translation += matrice_rotation(cam.tr.rotation_euler.x,-1.0f,0.0f,0.0f)*matrice_rotation(cam.tr.rotation_euler.z,0.0f,-1.0f,0.0f)*vec_directeur;
  }
  if (DOWN == true){
    cam.tr.translation -= matrice_rotation(cam.tr.rotation_euler.x,-1.0f,0.0f,0.0f)*matrice_rotation(cam.tr.rotation_euler.z,0.0f,-1.0f,0.0f)*vec_directeur;
  }
  if (RIGHT == true){
    cam.tr.translation -= matrice_rotation(cam.tr.rotation_euler.x,-1.0f,0.0f,0.0f)*matrice_rotation(cam.tr.rotation_euler.z,0.0f,-1.0f,0.0f)*vec_directeurlat;
  }
  if (LEFT == true){
    cam.tr.translation += matrice_rotation(cam.tr.rotation_euler.x,-1.0f,0.0f,0.0f)*matrice_rotation(cam.tr.rotation_euler.z,0.0f,-1.0f,0.0f)*vec_directeurlat;
  }
...
void init_model_2()
{
  ...
  obj[1].texture_id = glhelper::load_texture("data/SteelFloor.tga");
